    ...
    <div className="flex min-h-screen items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="text-center z-10 px-4">
        ...
        <div className="relative mb-8">
          <h1 className="text-[10rem] md:text-[14rem] font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-yellow-300 to-emerald-400 leading-none select-none">
            404
          </h1>
